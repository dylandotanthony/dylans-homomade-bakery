  ...
  return (
    <>
      ...
      <div className="d-flex justify-content-center flex-wrap gap-3 mb-4 mt-5 pt-3">
        ...
        <a href="https://www.instagram.com/dylanshomomadegoods" className="social-circle bg-instagram shadow-sm" target="_blank" rel="noopener noreferrer">
          <img src={instagramIcon} alt="Instagram" />
        </a>
        <a href="https://www.tiktok.com/@dylanshomomadegoods" className="social-circle bg-tiktok shadow-sm" target="_blank" rel="noopener noreferrer">
          <img src={tiktokIcon} alt="TikTok" />
        </a>
        <a href="https://www.linkedin.com/company/dylanshomomadegoods" className="social-circle bg-linkedin shadow-sm" target="_blank" rel="noopener noreferrer">
          <img src={linkedinIcon} alt="LinkedIn" />
        </a>
        <a href="https://nextdoor.com/page/dylans-homomade-goods-westminster-co/" className="social-circle bg-nextdoor shadow-sm" target="_blank" rel="noopener noreferrer">
          <img src={nextdoorIcon} alt="Nextdoor" />
        </a>
      </div>
    </>
  );
